...
class PasienInapAdmin extends StatefulWidget {
  final User user;

  const PasienInapAdmin({super.key, required this.user});

  @override
  State<PasienInapAdmin> createState() => _PasienInapAdminState();
}

class _PasienInapAdminState extends State<PasienInapAdmin> {
